...
<form>
		...
		//	alert("haha");
			...
			//	alert(msg.length);
				...
				for(i=0;i<msg.length;i++){
					var file=msg[i];
					url="/"+file.klfile_savepath+"/"+file.klfile_uuid;
	                   trFile+=("<tr><td><a target='_blank' href='"+url+"'>"+file.klfile_fileName+"</a></td>");
	...
	function showUserForm(){
		document.location="/filemanage_site/jsp/file/AddFile.jsp";
	}
	</script>
</html>